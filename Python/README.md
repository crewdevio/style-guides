# Crew Dev Python styles guides

This style guides is provided by Google.
_Python is the main dynamic language used at Google. This style guide is a list
of *dos and don'ts* for Python programs._
