...
_This style guide is based on [uber's style guide](https://github.com/uber-go/guide/blob/master/style.md) for Go lang_
...
For example, _1_ means that adding 24 hours to a time instant will not always
